...
<%@ page import="com.highfive.faq.model.vo.Faq" %>
<%
...
<body>
        ...
        <fieldset class="title">
            <legend>FAQ &nbsp;&nbsp;&nbsp;</legend>
            <form action="firmUpDeleteFaq" method="post" id="firmUpDeleteFaq">
            <table>
                <thead class="thead">
                    <tr>
						<td>선택</td>
                	...
                	<% } else { %>
                		<% for(Faq f : faqList) { %>
		                	<tr>
	                			...
	                			<td><input type="checkbox" name="dropFaqs" value="<%= f.getFaqNo() %>"></td>		                    
		                        <td><%= f.getFaqNo() %></td>
		                        <td><%= f.getFaqTitle() %></td>
		                    </tr>
		                 <% } %>
            ...
            <br><br>
                ...
                <button type="submit" class="btn btn-primary">FAQ 삭제</button>
	            	<button type="button" class="btn btn-secondary" onclick="newFaq();">새 FAQ 생성</button>
	            </div>
            </form>
        </fieldset>
    </div>
    ...
    <script>
           function newFaq(){
               location.href = "<%= contextPath %>/enrollform.faq"
           }
    </script>
