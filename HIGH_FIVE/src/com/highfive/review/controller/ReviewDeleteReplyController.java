...
/**
 * Servlet implementation class ReviewDeleteReplyController
 */
@WebServlet("/deleteReply.re")
public class ReviewDeleteReplyController extends HttpServlet {
     ...
     */
    public ReviewDeleteReplyController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result =new ReviewService().deleteReply(rCommentNo, userNo);
		
		if(result>0) {
								
				request.getSession().setAttribute("alertMsg", "댓글삭제성공");
