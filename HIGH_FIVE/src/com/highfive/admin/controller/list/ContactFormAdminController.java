...
/**
 * Servlet implementation class ContactFormAdminController
 */
@WebServlet("/contactFormAdmin")
public class ContactFormAdminController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/contactForm.jsp").forward(request, response);
	}
